...
func any_orders_past_this_floor_in_direction(floor int, dir elevio.MotorDirection) bool {
	...
	fmt.Println("Not supposed to happen: any_orders_past_this_floor_in_direction with dir = MD_Stop")
	return false
}
...
func elevator_should_stop_after_sensing_floor(floor int) bool {
	...
	fmt.Println("Not supposed to happen: elevator_should_stop_after_sensing_floor with dir = MD_Stop")
	return false
}
